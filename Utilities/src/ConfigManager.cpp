...
boost::program_options::variables_map parseCmdLineArgs(int argc, char **argv){
    ...
    cmdLineOptDesc.add_options()//przykładowe opcje, konieczne opracowanie sposobu na skatalogowanie wszystkich możliwych opcji
        ...
        ("ext",boost::program_options::value<std::vector<std::string>>()->multitoken()->default_value(std::vector<std::string>{std::string{".graw"}},".graw"),"allowed extensions")        ("files,f",boost::program_options::value<std::vector<std::string>>()->multitoken(),"strings - list of files to browse. Mutually exclusive with \"directory\"")
        ...
        ("input,i", boost::program_options::value<std::string>()->required(),"input root file")
        ...
        ("ms", boost::program_options::value<int>()->required(),"int - delay in ms")
        ...
        ("output,o", boost::program_options::value<std::string>(),"output root file,\nmutally exclusive with 'inplace'")
        ...
        ("reference", boost::program_options::value<std::string>()->required(),"reference root file")
...
boost::property_tree::ptree getConfig(int argc, char **argv){
    ...
    if (varMap.count("frameLoadRange")) {
