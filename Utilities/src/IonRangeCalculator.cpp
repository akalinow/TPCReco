...
////////////////////////////////////////////////
////////////////////////////////////////////////
void IonRangeCalculator::setGasMixture(gas_mixture_type gas)
{ // GAS index
...
////////////////////////////////////////////////
////////////////////////////////////////////////
void IonRangeCalculator::setGasPressure(double p_mbar)
{ // pressure [mbar]
  if (p_mbar > 0.0)
    myGasPressure = p_mbar;
  else
  {
...
////////////////////////////////////////////////
////////////////////////////////////////////////
void IonRangeCalculator::setGasTemperature(double T_Kelvin)
{ // temperature [K]
  if (T_Kelvin > 0.0)
    myGasTemperature = T_Kelvin;
  else
  {
...
////////////////////////////////////////////////
////////////////////////////////////////////////
void IonRangeCalculator::setGasConditions(gas_mixture_type gas, double p_mbar, double T_Kelvin)
{ // input: GAS index, pressure [mbar], temperature [K]
  setGasMixture(gas);
...
////////////////////////////////////////////////
////////////////////////////////////////////////
std::tuple<gas_mixture_type, double, double> IonRangeCalculator::getGasConditions()
{ // output: GAS index, pressure [mbar], temperature [K]
  return std::tuple<gas_mixture_type, double, double>(myGasMixture, myGasPressure, myGasTemperature);
}

////////////////////////////////////////////////
////////////////////////////////////////////////
double IonRangeCalculator::getGasRangeReferencePressure(pid_type ion)
{ // get reference pressure used to calculate Range(E_kin) curve for a given ion and the current gas mixture
  // sanity checks
...
////////////////////////////////////////////////
////////////////////////////////////////////////
double IonRangeCalculator::getGasRangeReferenceTemperature(pid_type ion)
{ // get reference temperature used to calculate Range(E_kin) curve for a given ion and the current gas mixture
  // sanity checks
  auto it = refGasRangeCurveMap.find(std::make_tuple(myGasMixture, ion));
  if (it == refGasRangeCurveMap.end())
  {
...
////////////////////////////////////////////////
////////////////////////////////////////////////
double IonRangeCalculator::getIonRangeMM(pid_type ion, double E_MeV)
{ // interpolated result in [mm] for current {gas, p, T}
...
////////////////////////////////////////////////
////////////////////////////////////////////////
double IonRangeCalculator::getIonEnergyMeV(pid_type ion, double range_mm)
{ // interpolated result in [MeV] for current {gas, p, T}
...
////////////////////////////////////////////////
////////////////////////////////////////////////
double IonRangeCalculator::getIonMassMeV(pid_type ion)
{ // particle or isotope mass in [MeV/c^2]
  return ionProp->GetAtomMass(ion);
}

////////////////////////////////////////////////
////////////////////////////////////////////////
void IonRangeCalculator::addIonRangeCurve(pid_type ion, gas_mixture_type gas, double p_mbar, double T_Kelvin, const std::string &datafile)
{ // range(E_kin) corresponding to {gas, p, T}
...
////////////////////////////////////////////////
////////////////////////////////////////////////
double IonRangeCalculator::getIonBraggCurveIntegralMeV(pid_type ion, double E_MeV, int Npoints)
{ // integral of dE/dx curve for the current {gas, p, T}
...
////////////////////////////////////////////////
////////////////////////////////////////////////
void IonRangeCalculator::addIonBraggCurve(pid_type ion, gas_mixture_type gas, double p_mbar, double T_Kelvin, const std::string &datafile)
{ // dE/dx(x) corresponding to {gas, p, T}
...
bool IonRangeCalculator::IsOK()
{
  ...
  if (refGasRangeCurveMap.size() && refBraggCurveMap.size() && myGasPressure > 0 && myGasTemperature > 0)
    result = true;
  return result;
}
////////////////////////////////////////////////
////////////////////////////////////////////////
void IonRangeCalculator::setEffectiveLengthCorrection(pid_type ion, double lengthScale, double lengthOffset_mm)
{ // effective correction for range to energy conversion
