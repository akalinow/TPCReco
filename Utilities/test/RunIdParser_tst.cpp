...
TEST(RunIdParser_GETFormat_Test, fileId) {
  ...
  EXPECT_EQ(RunIdParser("CoBo1_AsAd2_2018-04-19T16:39:05.506_0001.graw").fileId(), 1);
}
...
TEST(RunIdParser_GETFormat_Test, RunId) {
  ...
  EXPECT_EQ(RunIdParser("CoBo1_AsAd2_2018-04-19T16:39:05.506_0001.graw").runId(), 20180419163905);
}
...
TEST(RunIdParser_GETFormat_Test, CoBoId) {
  ...
  EXPECT_EQ(RunIdParser("CoBo1_AsAd2_2018-04-19T16:39:05.506_0001.graw").CoBoId(), 1);
}
...
TEST(RunIdParser_GETFormat_Test, AsAdId) {
  ...
  EXPECT_EQ(RunIdParser("CoBo1_AsAd2_2018-04-19T16:39:05.506_0001.graw").AsadId(), 2);
}
