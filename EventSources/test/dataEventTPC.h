...
std::string referenceDataFileName = "";
 ...
 std::map<std::string, std::string> Test_Reference_Titles = {
  ...
  std::map<std::string, double> Test_Reference = {
      ...
      {"get2DProjection(projection_type::DIR_TIME_U, filter_type::none, scale_type::raw)->GetEntries()"           , 155908.76829268009},
      {"get2DProjection(projection_type::DIR_TIME_U, filter_type::threshold, scale_type::raw)->GetEntries()"      , 226979.2987804875},
      {"get2DProjection(projection_type::DIR_TIME_U, filter_type::none, scale_type::raw)->GetSumOfWeights()"      , 155908.76829268009},
      {"get2DProjection(projection_type::DIR_TIME_U, filter_type::threshold, scale_type::raw)->GetSumOfWeights()" , 226979.2987804875},
      {"get2DProjection(projection_type::DIR_TIME_V, filter_type::none, scale_type::raw)->GetEntries()"           , 176881.81097560722},
      {"get2DProjection(projection_type::DIR_TIME_V, filter_type::threshold, scale_type::raw)->GetEntries()"      , 285676.20121951203},
      {"get2DProjection(projection_type::DIR_TIME_V, filter_type::none, scale_type::raw)->GetSumOfWeights()"      , 176881.81097563 },
      {"get2DProjection(projection_type::DIR_TIME_V, filter_type::threshold, scale_type::raw)->GetSumOfWeights()" , 285676.20121951221},
      {"get2DProjection(projection_type::DIR_TIME_W, filter_type::none, scale_type::raw)->GetEntries()"           , 187307          },
      {"get2DProjection(projection_type::DIR_TIME_W, filter_type::threshold, scale_type::raw)->GetEntries()"      , 282279.72560975613},
      {"get2DProjection(projection_type::DIR_TIME_W, filter_type::none, scale_type::raw)->GetSumOfWeights()"      , 187307.9634146  },
      {"get2DProjection(projection_type::DIR_TIME_W, filter_type::threshold, scale_type::raw)->GetSumOfWeights()" , 282279.72560975625},
      ...
      {"get2DProjection(projection_type::DIR_TIME_U, filter_type::none, scale_type::mm)->GetSumOfWeights()"       , 155908.76829268009},
      {"get2DProjection(projection_type::DIR_TIME_U, filter_type::threshold, scale_type::mm)->GetSumOfWeights()"  , 226979.2987804875},
      {"get2DProjection(projection_type::DIR_TIME_V, filter_type::none, scale_type::mm)->GetEntries()"            , 176881.81097560722},
      {"get2DProjection(projection_type::DIR_TIME_V, filter_type::threshold, scale_type::mm)->GetEntries()"       , 285676.20121951203},
      {"get2DProjection(projection_type::DIR_TIME_V, filter_type::none, scale_type::mm)->GetSumOfWeights()"       , 176881.81097560722},
      {"get2DProjection(projection_type::DIR_TIME_V, filter_type::threshold, scale_type::mm)->GetSumOfWeights()"  , 285676.20121951203},
      ...
      {"get2DProjection(projection_type::DIR_TIME_W, filter_type::threshold, scale_type::mm)->GetSumOfWeights()"  , 282279.72560975625} ,
