...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
EventSourceGeant4::EventSourceGeant4(const std::string & geometryFileName, std::shared_ptr<EventGenerator> eventGenerator)
    : EventSourceBase(),
      myEventGenerator(eventGenerator)
{
  std::cout << KGRN << "EventSourceGeant4::EventSourceGeant4()" << RST << std::endl;
  ...
  nEntries = 9999;
  std::cout << KGRN << "h3DChargeCloud" << RST << std::endl;
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
unsigned long int EventSourceGeant4::numberOfEvents() const{ return nEntries; }
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
TVector3 EventSourceGeant4::createVertex() const{
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
TrackSegment3D EventSourceGeant4::createSegment(const TVector3 vertexPos, pid_type ion_id, double energy) const{
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
TH1F EventSourceGeant4::createChargeProfile(double ion_range, pid_type ion_id) const{
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
Track3D EventSourceGeant4::createTrack(const TVector3 & aVtx, pid_type ion_id, double energy) const{
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
void EventSourceGeant4::fill3DChargeCloud(const Track3D & aTrack){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
void EventSourceGeant4::fillPEventTPC(const TH3D & h3DChargeCloud, const Track3D & aTrack){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
void EventSourceGeant4::generateSingleProng(pid_type ion_id){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
void EventSourceGeant4::generateTwoProng(){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
void EventSourceGeant4::generateThreeProng(){
...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
void EventSourceGeant4::generateEvent(){
