...
void HIGS_trees_analysis::fillTrees1prong(Track3D *aTrack, eventraw::EventInfo *aEventInfo){
  ...
  TrackSegment3DCollection list = aTrack->getSegments();
    ...
    event1prong_->runID=aEventInfo->GetRunId();
    event1prong_->eventID=aEventInfo->GetEventId();
    event1prong_->timestamp=aEventInfo->GetEventTimestamp(); 
    event1prong_->delta_timestamp=(double(aEventInfo->GetEventTimestamp())-last_timestamp)*1e-8; 
    last_timestamp=double(aEventInfo->GetEventTimestamp());
...
void HIGS_trees_analysis::fillTrees2prong(Track3D *aTrack, eventraw::EventInfo *aEventInfo){
  if(!Output2prongTreePtr){
    ...
    static double last_timestamp = 0;
    event2prong_->runID=aEventInfo->GetRunId();
    event2prong_->eventID=aEventInfo->GetEventId();
    event2prong_->timestamp=aEventInfo->GetEventTimestamp(); 
    event2prong_->delta_timestamp=(double(aEventInfo->GetEventTimestamp())-last_timestamp)*1e-8; 
    last_timestamp=double(aEventInfo->GetEventTimestamp());
...
void HIGS_trees_analysis::fillTrees3prong(Track3D *aTrack, eventraw::EventInfo *aEventInfo){
  ...
  std::sort(list.begin(), list.end(),
    ...
    static double last_timestamp = 0;
    event3prong_->runID=aEventInfo->GetRunId();
    event3prong_->eventID=aEventInfo->GetEventId();
    event3prong_->timestamp=aEventInfo->GetEventTimestamp(); 
    event3prong_->delta_timestamp=(double(aEventInfo->GetEventTimestamp())-last_timestamp)*1e-8; 
    last_timestamp=double(aEventInfo->GetEventTimestamp());
    ...
    event3prong_->alpha2_length = track2.getLength(); // longest = alpha
    ...
    event3prong_->alpha3_length = track3.getLength(); // longest = alpha
