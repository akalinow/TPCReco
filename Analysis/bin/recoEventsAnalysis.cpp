...
boost::program_options::variables_map parseCmdLineArgs(int argc, char **argv){
  ...
  cmdLineOptDesc.add_options()
    ...
    ("alphaMinCut", boost::program_options::value<float>()->default_value(0.0), "(option) float - minimal allowed ALPHA track length [mm] for selecting 16-O candidates, default=0 mm")
    ("alphaMaxCut", boost::program_options::value<float>()->default_value(300.0), "(option) float - maximal allowed ALPHA track length [mm] for selecting 16-O candidates, default=300 mm")
    ("carbonMinCut", boost::program_options::value<float>()->default_value(0.0), "(option) float - minimal allowed C-12 track length [mm] for selecting 16-O candidates, default=0 mm")
    ("carbonMaxCut", boost::program_options::value<float>()->default_value(300.0), "(option) float - maximal allowed C-12 track length [mm] for selecting 16-O candidates, default=300 mm")
