...
public:
	...
	void AddHit(std::tuple<direction, int, int> hit);     // valid range [0-2][1-1024][0-511]
	void AddEnvelopeHit(std::tuple<direction, int, int> hit);     // valid range [0-2][1-1024][0-511]
