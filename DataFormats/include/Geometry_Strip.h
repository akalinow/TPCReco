...
struct Strip_Data {
    projection dir; // projection/group: 0=U / 1=V / 2=W / 3=FPN / -1=ERROR                                                      
...
public:
    ...
    Geometry_Strip(projection dir_, int number, int cobo_index, int asad_index, int aget_index, int aget_channel, int aget_channel_raw,
