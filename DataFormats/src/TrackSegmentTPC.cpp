...
bool TrackSegment3D::SetComparisonCluster(SigClusterTPC &cluster) { // cluster = UVW clustered data
  ...
  trkMap[projection_type::DIR_U] = GetTrack2D(geo_ptr, projection_type::DIR_U);
  trkMap[projection_type::DIR_V] = GetTrack2D(geo_ptr, projection_type::DIR_V);
  trkMap[projection_type::DIR_W] = GetTrack2D(geo_ptr, projection_type::DIR_W);
